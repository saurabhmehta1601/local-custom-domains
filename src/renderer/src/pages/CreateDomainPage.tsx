...
const styles = {
  ...
  formBtn:
    'text-white rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center focus:ring-4 focus:outline-none',
  goBackBtn:
    ...
    <PageLayout>
      ...
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        <div className={styles.btnGroup}>
          ...
          <button type="submit" className={[styles.formBtn, styles.createBtn].join(' ')}>
            Submit
          </button>
        </div>
      </form>
