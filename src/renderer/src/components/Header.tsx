...
const styles = {
    ...
    title: "w-fit cursor-pointer bg-clip-text text-transparent bg-gradient-to-r from-amber-200 to-yellow-500",
    ...
    return (
        <div className={styles.container}>
            <div className="flex-1">
                <h1 className={styles.title} onClick={() => navigate("/")}>LCD</h1>
            </div>
